...
pub mod mc1_14 {
    ...
    entity_types! {
        ...
        AbstractHorse > Animal - "Bred" as bred: bool, "EatingHaystack" as eating_haystack: bool, optional "OwnerUUID" as owner_uuid: String, optional "SaddleItem" as saddle_item: super::compounds::ItemStack_save, "Tame" as tame: bool, "Temper" as temper: i32;
        ...
        AbstractMinecart > Entity - optional "CustomDisplayTile" as custom_display_tile: bool, optional "DisplayOffset" as display_offset: i32, optional "DisplayState" as display_state: super::compounds::NbtUtils_writeBlockState;
        ...
        AbstractVillager > AgableMob - "Inventory" as inventory: Vec<super::compounds::ItemStack_save>, optional "Offers" as offers: super::compounds::MerchantOffers_createTag;
        ...
        ItemEntity > Entity - "Age" as age: i16, "Health" as health: i16, optional "Item" as item: super::compounds::ItemStack_save, optional "Owner" as owner: super::compounds::NbtUtils_createUUIDTag, "PickupDelay" as pickup_delay: i16, optional "Thrower" as thrower: super::compounds::NbtUtils_createUUIDTag;
        ItemFrame > HangingEntity - "Facing" as facing: u8, optional "Item" as item: super::compounds::ItemStack_save, optional "ItemDropChance" as item_drop_chance: f32, optional "ItemRotation" as item_rotation: u8;
        ...
        LlamaSpit > Entity - optional "Owner" as owner: super::compounds::Compound11;
        MagmaCube > Slime - ;
        ...
        ThrownPotion > ThrowableProjectile - optional "Potion" as potion: super::compounds::ItemStack_save;
    ...
    entity_compound_types! {
        ...
        Compound11 - optional "OwnerUUID" as owner_uuid: u128;
        Compound7 - optional "UUID" as uuid: u128, optional "X" as x: i32, optional "Y" as y: i32, optional "Z" as z: i32;
        Entity_saveAsPassenger - "id" as id: String;
        ItemStack_save - "Count" as count: u8, "id" as id: String, optional "tag" as tag: std::collections::HashMap<String, fastnbt::Value>;
        ItemStack_save_1 - "Count" as count: u8, optional "Slot" as slot: u8, "id" as id: String, optional "tag" as tag: std::collections::HashMap<String, fastnbt::Value>;
        ...
        NbtUtils_createUUIDTag_1 - "L" as l: i64, "M" as m: i64, optional "X" as x: i32, optional "Y" as y: i32, optional "Z" as z: i32;
        NbtUtils_writeBlockPos - "X" as x: i32, "Y" as y: i32, "Z" as z: i32;
        NbtUtils_writeBlockState - "Name" as name: String, optional "Properties" as properties: std::collections::HashMap<String, fastnbt::Value>;
        ...
        SpawnData_save - "Entity" as entity: std::collections::HashMap<String, fastnbt::Value>, "Weight" as weight: i32;
    }
}
...
pub mod mc1_15 {
    ...
    entity_types! {
        "1.15";
        AbstractArrow > Entity - optional "OwnerUUID" as owner_uuid: u128, "PierceLevel" as pierce_level: u8, "ShotFromCrossbow" as shot_from_crossbow: bool, "SoundEvent" as sound_event: String, "crit" as crit: bool, "damage" as damage: f64, optional "inBlockState" as in_block_state: super::compounds::NbtUtils_writeBlockState, "inGround" as in_ground: bool, "life" as life: i16, "pickup" as pickup: u8, "shake" as shake: u8;
        AbstractChestedHorse > AbstractHorse - "ChestedHorse" as chested_horse: bool, optional "Items" as items: Vec<super::compounds::ItemStack_save_1>;
        AbstractFish > WaterAnimal - "FromBucket" as from_bucket: bool;
        AbstractGolem > PathfinderMob - ;
        AbstractHorse > Animal - "Bred" as bred: bool, "EatingHaystack" as eating_haystack: bool, optional "OwnerUUID" as owner_uuid: String, optional "SaddleItem" as saddle_item: super::compounds::ItemStack_save, "Tame" as tame: bool, "Temper" as temper: i32;
        ...
        AmbientCreature > Mob - ;
        Animal > AgableMob - "InLove" as in_love: i32, optional "LoveCause" as love_cause: u128;
        AreaEffectCloud > Entity - "Age" as age: i32, optional "Color" as color: i32, "Duration" as duration: i32, "DurationOnUse" as duration_on_use: i32, optional "Effects" as effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>, optional "OwnerUUID" as owner_uuid: u128, "Particle" as particle: String, optional "Potion" as potion: String, "Radius" as radius: f32, "RadiusOnUse" as radius_on_use: f32, "RadiusPerTick" as radius_per_tick: f32, "ReapplicationDelay" as reapplication_delay: i32, "WaitTime" as wait_time: i32;
        ArmorStand > LivingEntity - "ArmorItems" as armor_items: Vec<super::compounds::ItemStack_save>, "DisabledSlots" as disabled_slots: i32, "HandItems" as hand_items: Vec<super::compounds::ItemStack_save>, "Invisible" as invisible: bool, optional "Marker" as marker: bool, "NoBasePlate" as no_base_plate: bool, "Pose" as pose: super::compounds::ArmorStand_writePose, "ShowArms" as show_arms: bool, "Small" as small: bool;
        Arrow > AbstractArrow - optional "Color" as color: i32, optional "CustomPotionEffects" as custom_potion_effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>, optional "Potion" as potion: String;
        Bat > AmbientCreature - "BatFlags" as bat_flags: u8;
        ...
        LeashFenceKnotEntity > HangingEntity - ;
        LightningBolt > Entity - ;
        LivingEntity > Entity - "AbsorptionAmount" as absorption_amount: f32, optional "ActiveEffects" as active_effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>, "Attributes" as attributes: Vec<super::compounds::SharedMonsterAttributes_saveAttribute>, "Brain" as brain: fastnbt::Value, "DeathTime" as death_time: i16, "FallFlying" as fall_flying: bool, "Health" as health: f32, "HurtByTimestamp" as hurt_by_timestamp: i32, "HurtTime" as hurt_time: i16, optional "SleepingX" as sleeping_x: i32, optional "SleepingY" as sleeping_y: i32, optional "SleepingZ" as sleeping_z: i32;
        Llama > AbstractChestedHorse - optional "DecorItem" as decor_item: super::compounds::ItemStack_save, "Strength" as strength: i32, "Variant" as variant: i32;
        LlamaSpit > Entity - optional "Owner" as owner: super::compounds::Compound11;
        MagmaCube > Slime - ;
        Minecart > AbstractMinecart - ;
        ...
        MinecartSpawner > AbstractMinecart - "Delay" as delay: i16, "MaxNearbyEntities" as max_nearby_entities: i16, "MaxSpawnDelay" as max_spawn_delay: i16, "MinSpawnDelay" as min_spawn_delay: i16, "RequiredPlayerRange" as required_player_range: i16, "SpawnCount" as spawn_count: i16, "SpawnData" as spawn_data: std::collections::HashMap<String, fastnbt::Value>, "SpawnPotentials" as spawn_potentials: Vec<super::compounds::SpawnData_save>, "SpawnRange" as spawn_range: i16;
        MinecartTNT > AbstractMinecart - "TNTFuse" as tnt_fuse: i32;
        Mob > LivingEntity - "ArmorDropChances" as armor_drop_chances: Vec<f32>, "ArmorItems" as armor_items: Vec<super::compounds::ItemStack_save>, "CanPickUpLoot" as can_pick_up_loot: bool, optional "DeathLootTable" as death_loot_table: String, optional "DeathLootTableSeed" as death_loot_table_seed: i64, "HandDropChances" as hand_drop_chances: Vec<f32>, "HandItems" as hand_items: Vec<super::compounds::ItemStack_save>, "Leash" as leash: super::compounds::Compound7, "LeftHanded" as left_handed: bool, optional "NoAI" as no_ai: bool, "PersistenceRequired" as persistence_required: bool;
        Monster > PathfinderMob - ;
        Mule > AbstractChestedHorse - ;
        MushroomCow > Cow - optional "EffectDuration" as effect_duration: i32, optional "EffectId" as effect_id: u8, "Type" as r#type: String;
        Ocelot > Animal - "Trusting" as trusting: bool;
    ...
    entity_compound_types! {
        ...
        MerchantOffer_createTag - "buy" as buy: super::compounds::ItemStack_save, "buyB" as buy_b: super::compounds::ItemStack_save, "demand" as demand: i32, "maxUses" as max_uses: i32, "priceMultiplier" as price_multiplier: f32, "rewardExp" as reward_exp: bool, "sell" as sell: super::compounds::ItemStack_save, "specialPrice" as special_price: i32, "uses" as uses: i32, "xp" as xp: i32;
        MerchantOffers_createTag - "Recipes" as recipes: Vec<super::compounds::MerchantOffer_createTag>;
        MobEffectInstance_writeDetailsTo - "Ambient" as ambient: bool, "Amplifier" as amplifier: u8, "Duration" as duration: i32, optional "HiddenEffect" as hidden_effect: std::collections::HashMap<String, fastnbt::Value>, "Id" as id: u8, "ShowIcon" as show_icon: bool, "ShowParticles" as show_particles: bool;
        NbtUtils_createUUIDTag - "L" as l: i64, "M" as m: i64;
        NbtUtils_createUUIDTag_1 - "L" as l: i64, "M" as m: i64, optional "X" as x: i32, optional "Y" as y: i32, optional "Z" as z: i32;
        NbtUtils_writeBlockPos - "X" as x: i32, "Y" as y: i32, "Z" as z: i32;
        NbtUtils_writeBlockState - "Name" as name: String, optional "Properties" as properties: std::collections::HashMap<String, fastnbt::Value>;
...
pub mod mc1_16 {
    ...
    entity_types! {
        ...
        AmbientCreature > Mob - ;
        Animal > AgableMob - "InLove" as in_love: i32, optional "LoveCause" as love_cause: u128;
        AreaEffectCloud > Entity - "Age" as age: i32, optional "Color" as color: i32, "Duration" as duration: i32, "DurationOnUse" as duration_on_use: i32, optional "Effects" as effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>, optional "Owner" as owner: u128, "Particle" as particle: String, optional "Potion" as potion: String, "Radius" as radius: f32, "RadiusOnUse" as radius_on_use: f32, "RadiusPerTick" as radius_per_tick: f32, "ReapplicationDelay" as reapplication_delay: i32, "WaitTime" as wait_time: i32;
        ArmorStand > LivingEntity - "ArmorItems" as armor_items: Vec<super::compounds::ItemStack_save>, "DisabledSlots" as disabled_slots: i32, "HandItems" as hand_items: Vec<super::compounds::ItemStack_save>, "Invisible" as invisible: bool, optional "Marker" as marker: bool, "NoBasePlate" as no_base_plate: bool, "Pose" as pose: super::compounds::ArmorStand_writePose, "ShowArms" as show_arms: bool, "Small" as small: bool;
        Arrow > AbstractArrow - optional "Color" as color: i32, optional "CustomPotionEffects" as custom_potion_effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>, optional "Potion" as potion: String;
        Bat > AmbientCreature - "BatFlags" as bat_flags: u8;
        ...
        EndCrystal > Entity - optional "BeamTarget" as beam_target: super::compounds::NbtUtils_writeBlockPos, "ShowBottom" as show_bottom: bool;
        EnderDragon > Mob - "DragonPhase" as dragon_phase: i32;
        EnderMan > Monster - "AngerTime" as anger_time: i32, optional "AngryAt" as angry_at: u128, optional "carriedBlockState" as carried_block_state: super::compounds::NbtUtils_writeBlockState;
        Endermite > Monster - "Lifetime" as lifetime: i32, "PlayerSpawned" as player_spawned: bool;
        ...
        LeashFenceKnotEntity > HangingEntity - ;
        LightningBolt > Entity - ;
        LivingEntity > Entity - "AbsorptionAmount" as absorption_amount: f32, optional "ActiveEffects" as active_effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>, "Attributes" as attributes: Vec<super::compounds::AttributeInstance_save>, optional "Brain" as brain: fastnbt::Value, "DeathTime" as death_time: i16, "FallFlying" as fall_flying: bool, "Health" as health: f32, "HurtByTimestamp" as hurt_by_timestamp: i32, "HurtTime" as hurt_time: i16, optional "SleepingX" as sleeping_x: i32, optional "SleepingY" as sleeping_y: i32, optional "SleepingZ" as sleeping_z: i32;
        Llama > AbstractChestedHorse - optional "DecorItem" as decor_item: super::compounds::ItemStack_save, "Strength" as strength: i32, "Variant" as variant: i32;
...
pub mod mc1_17_mc1_18 {
    ...
    entity_types! {
        ...
        Entity - "Air" as air: i16, optional "CustomName" as custom_name: String, optional "CustomNameVisible" as custom_name_visible: bool, "FallDistance" as fall_distance: f32, "Fire" as fire: i16, optional "Glowing" as glowing: bool, optional "HasVisualFire" as has_visual_fire: bool, "Invulnerable" as invulnerable: bool, "Motion" as motion: Vec<f64>, optional "NoGravity" as no_gravity: bool, "OnGround" as on_ground: bool, optional "Passengers" as passengers: Vec<super::compounds::Entity_saveAsPassenger>, "PortalCooldown" as portal_cooldown: i32, "Pos" as pos: Vec<f64>, "Rotation" as rotation: Vec<f32>, optional "Silent" as silent: bool, optional "Tags" as tags: Vec<String>, optional "TicksFrozen" as ticks_frozen: i32, "UUID" as uuid: u128;
        Evoker > SpellcasterIllager - ;
        EvokerFangs > Entity - optional "Owner" as owner: u128, "Warmup" as warmup: i32;
...
pub mod mc1_19 {
    ...
    entity_types! {
        ...
        CaveSpider > Spider - ;
        ChestBoat > Boat - optional "Items" as items: Vec<super::compounds::ItemStack_save_1>, optional "LootTable" as loot_table: String, optional "LootTableSeed" as loot_table_seed: i64;
        Chicken > Animal - "EggLayTime" as egg_lay_time: i32, "IsChickenJockey" as is_chicken_jockey: bool;
        Cod > AbstractSchoolingFish - ;
        Cow > Animal - ;
        Creeper > Monster - "ExplosionRadius" as explosion_radius: u8, "Fuse" as fuse: i16, "ignited" as ignited: bool, optional "powered" as powered: bool;
        ...
        MinecartSpawner > AbstractMinecart - "Delay" as delay: i16, "MaxNearbyEntities" as max_nearby_entities: i16, "MaxSpawnDelay" as max_spawn_delay: i16, "MinSpawnDelay" as min_spawn_delay: i16, "RequiredPlayerRange" as required_player_range: i16, "SpawnCount" as spawn_count: i16, "SpawnData" as spawn_data: fastnbt::Value, "SpawnPotentials" as spawn_potentials: fastnbt::Value, "SpawnRange" as spawn_range: i16;
        MinecartTNT > AbstractMinecart - "TNTFuse" as tnt_fuse: i32;
        Mob > LivingEntity - "ArmorDropChances" as armor_drop_chances: Vec<f32>, "ArmorItems" as armor_items: Vec<super::compounds::ItemStack_save>, "CanPickUpLoot" as can_pick_up_loot: bool, optional "DeathLootTable" as death_loot_table: String, optional "DeathLootTableSeed" as death_loot_table_seed: i64, "HandDropChances" as hand_drop_chances: Vec<f32>, "HandItems" as hand_items: Vec<super::compounds::ItemStack_save>, "Leash" as leash: super::compounds::Compound2, "LeftHanded" as left_handed: bool, optional "NoAI" as no_ai: bool, "PersistenceRequired" as persistence_required: bool;
        Monster > PathfinderMob - ;
        Mule > AbstractChestedHorse - ;
    ...
    entity_compound_types! {
        ...
        MerchantOffer_createTag - "buy" as buy: super::compounds::ItemStack_save, "buyB" as buy_b: super::compounds::ItemStack_save, "demand" as demand: i32, "maxUses" as max_uses: i32, "priceMultiplier" as price_multiplier: f32, "rewardExp" as reward_exp: bool, "sell" as sell: super::compounds::ItemStack_save, "specialPrice" as special_price: i32, "uses" as uses: i32, "xp" as xp: i32;
        MerchantOffers_createTag - "Recipes" as recipes: Vec<super::compounds::MerchantOffer_createTag>;
        MobEffectInstance_writeDetailsTo - "Ambient" as ambient: bool, "Amplifier" as amplifier: u8, "Duration" as duration: i32, optional "FactorCalculationData" as factor_calculation_data: fastnbt::Value, optional "HiddenEffect" as hidden_effect: std::collections::HashMap<String, fastnbt::Value>, "Id" as id: i32, "ShowIcon" as show_icon: bool, "ShowParticles" as show_particles: bool;
        NbtUtils_writeBlockPos - "X" as x: i32, "Y" as y: i32, "Z" as z: i32;
        NbtUtils_writeBlockState - "Name" as name: String, optional "Properties" as properties: std::collections::HashMap<String, fastnbt::Value>;
    }
}
...
pub mod mc1_19_4 {
    ...
    entity_types! {
        ...
        Bee > Animal - "AngerTime" as anger_time: i32, optional "AngryAt" as angry_at: u128, "CannotEnterHiveTicks" as cannot_enter_hive_ticks: i32, "CropsGrownSincePollination" as crops_grown_since_pollination: i32, optional "FlowerPos" as flower_pos: super::compounds::NbtUtils_writeBlockPos, "HasNectar" as has_nectar: bool, "HasStung" as has_stung: bool, optional "HivePos" as hive_pos: super::compounds::NbtUtils_writeBlockPos, "TicksSincePollination" as ticks_since_pollination: i32;
        Blaze > Monster - ;
        BlockDisplay > Display - "block_state" as block_state: super::compounds::NbtUtils_writeBlockState;
        Boat > Entity - "Type" as r#type: String;
...
pub mod mc1_20 {
    ...
    entity_types! {
        ...
        ExperienceOrb > Entity - "Age" as age: i16, "Count" as count: i32, "Health" as health: i16, "Value" as value: i16;
        EyeOfEnder > Entity - optional "Item" as item: super::compounds::ItemStack_save;
        FallingBlockEntity > Entity - "BlockState" as block_state: super::compounds::NbtUtils_writeBlockState, "CancelDrop" as cancel_drop: bool, "DropItem" as drop_item: bool, "FallHurtAmount" as fall_hurt_amount: f32, "FallHurtMax" as fall_hurt_max: i32, "HurtEntities" as hurt_entities: bool, optional "TileEntityData" as tile_entity_data: std::collections::HashMap<String, fastnbt::Value>, "Time" as time: i32;
        Fireball > AbstractHurtingProjectile - optional "Item" as item: super::compounds::ItemStack_save;
        FireworkRocketEntity > Projectile - optional "FireworksItem" as fireworks_item: super::compounds::ItemStack_save, "Life" as life: i32, "LifeTime" as life_time: i32, "ShotAtAngle" as shot_at_angle: bool;
        FishingHook > Projectile - ;
        FlyingMob > Mob - ;
...
pub mod mc1_20_2 {
    ...
    entity_types! {
        ...
        AmbientCreature > Mob - ;
        Animal > AgeableMob - "InLove" as in_love: i32, optional "LoveCause" as love_cause: u128;
        AreaEffectCloud > Entity - "Age" as age: i32, optional "Color" as color: i32, "Duration" as duration: i32, "DurationOnUse" as duration_on_use: i32, optional "Owner" as owner: u128, "Particle" as particle: String, optional "Potion" as potion: String, "Radius" as radius: f32, "RadiusOnUse" as radius_on_use: f32, "RadiusPerTick" as radius_per_tick: f32, "ReapplicationDelay" as reapplication_delay: i32, "WaitTime" as wait_time: i32, optional "effects" as effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>;
        ArmorStand > LivingEntity - "ArmorItems" as armor_items: Vec<super::compounds::ItemStack_save>, "DisabledSlots" as disabled_slots: i32, "HandItems" as hand_items: Vec<super::compounds::ItemStack_save>, "Invisible" as invisible: bool, optional "Marker" as marker: bool, "NoBasePlate" as no_base_plate: bool, "Pose" as pose: super::compounds::ArmorStand_writePose, "ShowArms" as show_arms: bool, "Small" as small: bool;
        Arrow > AbstractArrow - optional "Color" as color: i32, optional "Potion" as potion: String, optional "custom_potion_effects" as custom_potion_effects: Vec<super::compounds::MobEffectInstance_writeDetailsTo>;
        Axolotl > Animal - "FromBucket" as from_bucket: bool, "Variant" as variant: i32;
        Bat > AmbientCreature - "BatFlags" as bat_flags: u8;
        Bee > Animal - "AngerTime" as anger_time: i32, optional "AngryAt" as angry_at: u128, "CannotEnterHiveTicks" as cannot_enter_hive_ticks: i32, "CropsGrownSincePollination" as crops_grown_since_pollination: i32, optional "FlowerPos" as flower_pos: super::compounds::NbtUtils_writeBlockPos, "HasNectar" as has_nectar: bool, "HasStung" as has_stung: bool, optional "HivePos" as hive_pos: super::compounds::NbtUtils_writeBlockPos, "TicksSincePollination" as ticks_since_pollination: i32;
        Blaze > Monster - ;
    ...
    entity_compound_types! {
        ...
        MerchantOffer_createTag - "buy" as buy: super::compounds::ItemStack_save, "buyB" as buy_b: super::compounds::ItemStack_save, "demand" as demand: i32, "maxUses" as max_uses: i32, "priceMultiplier" as price_multiplier: f32, "rewardExp" as reward_exp: bool, "sell" as sell: super::compounds::ItemStack_save, "specialPrice" as special_price: i32, "uses" as uses: i32, "xp" as xp: i32;
        MerchantOffers_createTag - "Recipes" as recipes: Vec<super::compounds::MerchantOffer_createTag>;
        MobEffectInstance_writeDetailsTo - "ambient" as ambient: bool, "amplifier" as amplifier: u8, "duration" as duration: i32, optional "factor_calculation_data" as factor_calculation_data: fastnbt::Value, optional "hidden_effect" as hidden_effect: std::collections::HashMap<String, fastnbt::Value>, "id" as id: String, "show_icon" as show_icon: bool, "show_particles" as show_particles: bool;
        NbtUtils_writeBlockPos - "X" as x: i32, "Y" as y: i32, "Z" as z: i32;
        NbtUtils_writeBlockState - "Name" as name: String, optional "Properties" as properties: std::collections::HashMap<String, fastnbt::Value>;
    }
}
...
pub mod mc1_20_3 {
    ...
    entity_types! {
        "1.20.3";
        AbstractArrow > Projectile - "PierceLevel" as pierce_level: u8, "ShotFromCrossbow" as shot_from_crossbow: bool, "SoundEvent" as sound_event: String, "crit" as crit: bool, "damage" as damage: f64, optional "inBlockState" as in_block_state: super::compounds::NbtUtils_writeBlockState, "inGround" as in_ground: bool, "item" as item: super::compounds::ItemStack_save, "life" as life: i16, "pickup" as pickup: u8, "shake" as shake: u8;
        AbstractChestedHorse > AbstractHorse - "ChestedHorse" as chested_horse: bool, optional "Items" as items: Vec<super::compounds::ItemStack_save_1>;
        AbstractFish > WaterAnimal - "FromBucket" as from_bucket: bool;
        AbstractGolem > PathfinderMob - ;
        AbstractHorse > Animal - "Bred" as bred: bool, "EatingHaystack" as eating_haystack: bool, optional "Owner" as owner: u128, optional "SaddleItem" as saddle_item: super::compounds::ItemStack_save, "Tame" as tame: bool, "Temper" as temper: i32;
        AbstractHurtingProjectile > Projectile - "power" as power: Vec<f64>;
        AbstractIllager > Raider - ;
        AbstractMinecart > VehicleEntity - optional "CustomDisplayTile" as custom_display_tile: bool, optional "DisplayOffset" as display_offset: i32, optional "DisplayState" as display_state: super::compounds::NbtUtils_writeBlockState;
        AbstractMinecartContainer > AbstractMinecart - optional "Items" as items: Vec<super::compounds::ItemStack_save_1>, optional "LootTable" as loot_table: String, optional "LootTableSeed" as loot_table_seed: i64;
        AbstractPiglin > Monster - optional "IsImmuneToZombification" as is_immune_to_zombification: bool, "TimeInOverworld" as time_in_overworld: i32;
        AbstractSchoolingFish > AbstractFish - ;
        AbstractSkeleton > Monster - ;
        ...
        Pillager > AbstractIllager - "Inventory" as inventory: Vec<super::compounds::ItemStack_save>;
        PolarBear > Animal - "AngerTime" as anger_time: i32, optional "AngryAt" as angry_at: u128;
        PrimedTnt > Entity - "block_state" as block_state: super::compounds::NbtUtils_writeBlockState, "fuse" as fuse: i16;
        Projectile > Entity - "HasBeenShot" as has_been_shot: bool, optional "LeftOwner" as left_owner: bool, optional "Owner" as owner: u128;
        Pufferfish > AbstractFish - "PuffState" as puff_state: i32;
        Rabbit > Animal - "MoreCarrotTicks" as more_carrot_ticks: i32, "RabbitType" as rabbit_type: i32;
        Raider > PatrollingMonster - "CanJoinRaid" as can_join_raid: bool, optional "RaidId" as raid_id: i32, "Wave" as wave: i32;
...
pub mod mc1_20_5 {
    ...
    entity_types! {
        "1.20.5";
        AbstractArrow > Projectile - "PierceLevel" as pierce_level: u8, "ShotFromCrossbow" as shot_from_crossbow: bool, "SoundEvent" as sound_event: String, "crit" as crit: bool, "damage" as damage: f64, optional "inBlockState" as in_block_state: super::compounds::NbtUtils_writeBlockState, "inGround" as in_ground: bool, "item" as item: fastnbt::Value, "life" as life: i16, "pickup" as pickup: u8, "shake" as shake: u8;
        ...
        ArmorStand > LivingEntity - "ArmorItems" as armor_items: Vec<std::collections::HashMap<String, fastnbt::Value>>, "DisabledSlots" as disabled_slots: i32, "HandItems" as hand_items: Vec<std::collections::HashMap<String, fastnbt::Value>>, "Invisible" as invisible: bool, optional "Marker" as marker: bool, "NoBasePlate" as no_base_plate: bool, "Pose" as pose: super::compounds::ArmorStand_writePose, "ShowArms" as show_arms: bool, "Small" as small: bool;
        Arrow > AbstractArrow - ;
        Axolotl > Animal - "FromBucket" as from_bucket: bool, "Variant" as variant: i32;
        Bat > AmbientCreature - "BatFlags" as bat_flags: u8;
