...
pub mod mc1_14 {
    block_entities! {
        ...
        "minecraft:enchanting_table", EnchantingTable: EnchantmentTableBlockEntity (> BlockEntity);
...
/// Block entities for Minecraft 1.17-1.18.
...
pub mod mc1_19_4 {
    block_entities! {
        ...
        "minecraft:sculk_shrieker", SculkShrieker: SculkShriekerBlockEntity (> BlockEntity);
        "minecraft:chiseled_bookshelf", ChiseledBookshelf: ChiseledBookShelfBlockEntity (> BlockEntity);
        "minecraft:suspicious_sand", SuspiciousSand: SuspiciousSandBlockEntity (> BlockEntity);
